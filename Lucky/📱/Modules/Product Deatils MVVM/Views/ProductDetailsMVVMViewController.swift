//
//  ProductDetailsMVVMViewController.swift
//  Lucky
//
...
class ProductDetailsMVVMViewController: UIViewController {
    ...
    init(with viewModel: ProductDetailsViewModel) {
    ...
    private func getProductDetails() {
        ...
        viewModel.getProductDetails().subscribe(onSuccess: { [weak self] (productInfo) in
